 ...
 * (packages/shared/src/contracts/agent-tools.ts) field-for-field; the Zod schema is still used
...
/**
 * `defineTool`'s TypeBox mirror of `proposeDocumentEditParams` (packages/shared/src/contracts/
