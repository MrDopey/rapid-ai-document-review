...
// User Story 4/FR-013b (research.md R10, data-model.md's "Exported document session"): a fresh,
// on-demand genuine whole-document Pi-native session export — the query schema for
